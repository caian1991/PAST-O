...
//FUNÇÃO 2 = getElementByClassName()
...
function mudarTexto() {
    ...
    titulo.textContent = "Caian Breacking Bad";
...
function adicionarBadge() {
    ...
    hl("#badge-container", "element-selecionado", 2000);
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    cardHover.addEventListener("mouseover", function () {
        ...
        cardHover.backgroundcolor = "#2a2a2a"
...
function filtraFilmes(termoBusca) {
