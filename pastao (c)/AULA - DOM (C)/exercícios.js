...
function exercicio1() {
    ...
    const tituloEx1 = document.getElementById("titulo-ex1");
  
    const resultadoEx1 = document.getElementById("resultado-ex1");

    resultadoEx1.textContent = "Título encontrado:" + tituloEx1.textContent;
...
function exercicio2() {
    ...
    if (favoritado) {
        ...
        botao.textContent = "Desfavotitar"

        resultado.textContent = ("Breacking bad foi favoritado!")
